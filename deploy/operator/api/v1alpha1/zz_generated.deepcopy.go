...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GMSClientSpec) DeepCopyInto(out *GMSClientSpec) {
	*out = *in
	if in.Command != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GMSClientSpec.
func (in *GMSClientSpec) DeepCopy() *GMSClientSpec {
	if in == nil {
		return nil
	}
	out := new(GMSClientSpec)
