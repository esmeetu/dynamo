...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GMSSidecarSpec) DeepCopyInto(out *GMSSidecarSpec) {
	*out = *in
	if in.Command != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GMSSidecarSpec.
func (in *GMSSidecarSpec) DeepCopy() *GMSSidecarSpec {
	if in == nil {
		return nil
	}
	out := new(GMSSidecarSpec)
