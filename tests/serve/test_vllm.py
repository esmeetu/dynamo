...
# ─────────────────────────────────────────────────────────────────────────────
# Multi-worker embedding tests (DIS-2098)
#
...
def test_embedding_multi_worker_same_model_load_balance(
    ...
    Acceptance for DIS-2098 (1). Burst size is deliberately small (20) so
    pure chance of all-to-one-worker is negligible (≈ 1 in 2^19) while
    keeping test runtime tight on 2-GPU CI nodes.
    """
